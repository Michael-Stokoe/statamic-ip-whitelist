...
<div class="flex items-center justify-between mb-6">
    ...
    <div class="flex space-x-3">
        ...
        <button onclick="Statamic.$hooks.call('ip-whitelist-add')" class="btn-primary">
            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="p-6 border-b border-gray-200 dark:border-gray-700">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                <form method="POST" action="{{ cp_route('ip-whitelist.store') }}">
                    @csrf
                    <input type="hidden" name="ip" value="{{ $currentIp }}">
                    <input type="hidden" name="name" value="Current IP">
                    ...
                    @foreach($ips as $ip)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <form method="POST" action="{{ cp_route('ip-whitelist.destroy', $ip['ip']) }}" style="display:inline" onsubmit="return confirm('Are you sure you want to remove this IP address?')">
                                    @csrf
                                    @method('DELETE')
